		...
		if (this.capabilities.cool) {
			this.HeaterCoolerService.getCharacteristic(Characteristic.CoolingThresholdTemperature)
				.setProps({
					...
					maxValue: this.capabilities.cool.temperatures[CELSIUS_ABBR].values[this.capabilities.cool.temperatures[this.temperatureUnit].values.length - 1],
					minStep: tempStep
				})
		...
		if (this.capabilities.heat) {
			this.HeaterCoolerService.getCharacteristic(Characteristic.HeatingThresholdTemperature)
				.setProps({
					...
					maxValue: this.capabilities.heat.temperatures[CELSIUS_ABBR].values[this.capabilities.cool.temperatures[this.temperatureUnit].values.length - 1],
					minStep: tempStep
				})
